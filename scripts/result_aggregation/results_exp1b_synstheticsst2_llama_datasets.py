...
regex = re.compile("e2_(llama)_.*(sst2|mnli|conll)(rand|bootstrapped)?_\d+_\d_predictions.jsonl")
...
l1 = sorted([x for x in l1 if regex.match(x)])
print(l1)
...
for file in tqdm(l1):
    ...
    print(file, r["custom_score"], r["gpt-4_lm_score"])
...
out_name = "outputs/results_exp1b_synthetic_datasets.csv"
if os.path.exists(out_name):
    import datetime

    out_name = f"outputs/results_exp1b_synthetic_datasets_{datetime.date.today()}.csv"
